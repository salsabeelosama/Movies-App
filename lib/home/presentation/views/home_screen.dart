...
import '../../data/respositories/home_respository_impl.dart';
...
class _HomeContentViewState extends State<HomeContentView> {
      ...
      child: BlocBuilder<HomeBloc, HomeState>(
        builder: (context, state) {
          ...
          if (state is HomeLoaded) {
            ...
            if (_featuredCurrentIndex >= state.movies.length) {
              _featuredCurrentIndex = 0;
            }

            final scientificMovies = state.movies.where((movie) {
            ...
            final actionMovies = state.movies.where((movie) {
              return movie.genres.any(
                    (genre) => genre.toLowerCase() == 'action',
              );
            }).toList();

            final romanceMovies = state.movies.where((movie) {
              return movie.genres.any(
            ...
            final currentMovie =
            state.movies[_featuredCurrentIndex];
  ...
  Widget _buildFullScreenBackground(Movie movie) {
