                ...
                child: Column(
                  children: [
                    ...
                    CustomTextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.trim().isEmpty) {
                          return AppTexts.nameRequired.tr();
                        }
                    ...
                    CustomTextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.trim().isEmpty) {
                          return AppTexts.emailRequired.tr();
                        }

                        if (!value.contains('@')) {
                          return AppTexts.validEmail.tr();
                        }
                    ...
                    CustomTextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (passController.text != confPassController.text) {
                          return AppTexts.passwordsNotMatch.tr();
                        }
                    ...
                    CustomTextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.trim().isEmpty) {
                          return AppTexts.phoneRequired.tr();
                        }
                      },
                    ),
